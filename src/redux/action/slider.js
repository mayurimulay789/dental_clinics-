...
export const createSlider = (formdata) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${server}/sliders/createSliderImage`,
      formdata,
      {
        headers: {
...
export const updateSlider = (formdata, sliderId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${server}/sliders/updateSliderImage/${sliderId}`,
      formdata,
      {
        headers: {
          "Content-type": "multipart/form-data",
...
export const getAllSliderImages = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/sliders/getAllSliderImages`, {
      headers: {
...
export const deleteSliderImage = (sliderId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${server}/sliders/deleteSliderImage/${sliderId}`,
      {
        headers: {
          "Content-type": "application/json",
        },
